...
parser = argparse.ArgumentParser(description="Script to create a voice pack from a dictionary")
...
audiofilestools.create_voicepack(args.dico, args.engine, args.config, args.output)